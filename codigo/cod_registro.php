<?php
    ...
    //Una función para generar el mail de validación
    function email_valid($email, $hash) {
        $asunto = "Donar es ayudar - Activación de cuenta";
        $mensaje = "
        ¡Gracias por registrarse!<br>
        Su cuenta ha sido creada, pero sólo falta verificarla.<br><br>
        
        Haga click en el siguiente enlace para verificar su cuenta:<br>
        https://donaresayudar1.000webhostapp.com/verificacion.php?email=" . $email . "&hash=" . $hash . "";
